...
public class GradientCircleGauge extends LinearLayout {
    ...
    public void setGaugeLevel(@IntRange(from = 0, to = 200) int level, String symbol) {
        this.symbol = symbol;
     ...
     */
    public void setGaugeLevel(@IntRange(from = 0, to = 200) int level, boolean pauseAnimation) {
