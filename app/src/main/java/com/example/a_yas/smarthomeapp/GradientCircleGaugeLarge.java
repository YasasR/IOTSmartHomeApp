...
public class GradientCircleGaugeLarge extends LinearLayout {
    ...
    /**
     * FIXME: allow changing radius and thickness
     **/
    private int bgColor;
    ...
    private final String LOG_TAG = GradientCircleGaugeLarge.class.getSimpleName();

    public GradientCircleGaugeLarge(Context context) {
        super(context);
    ...
    public GradientCircleGaugeLarge(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public GradientCircleGaugeLarge(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }

    public GradientCircleGaugeLarge(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        this(context, attrs);
    }
    ...
    private void setInitDefaults(Context context) {
        ...
        mRadius = getResources().getDimension(R.dimen.default_circle_gauge_radius_l);
        mThickness = getResources().getDimension(R.dimen.default_circle_gauge_radius_l);
        mTitleText = "";
        ...
        mTitleTextRadius = context.getResources().getDimension(R.dimen.default_circle_gauge_text_radius_l);
        mTitleTextSize = context.getResources().getDimension(R.dimen.default_circle_gague_text_size);
        mZeroAxisDegrees = 0; //top
    ...
    private void init() {
        ...
        final View vRoot = inflater.inflate(R.layout.gradient_circle_gauge_large, null, false);
        ...
        mProgressBarFg.setRotation(0); // progress starts at 0
    ...
    private void setProgressAnimation(int level) {
        ...
        setProgressTextValue(level + symbol);
    }


    public void setGaugeLevel(@IntRange(from = 0, to = 1000) int level, String symbol) {
        this.symbol = symbol;
     ...
     */
    public void setGaugeLevel(@IntRange(from = 0, to = 1000) int level, boolean pauseAnimation) {
    ...
    private class CurvedTextView extends android.support.v7.widget.AppCompatTextView {
        private Path myArc;
        ...
        private void initDefaults(Context context) {
            ...
            mTitleTextRadius = getResources().getDimension(R.dimen.default_circle_gauge_text_radius_l);
